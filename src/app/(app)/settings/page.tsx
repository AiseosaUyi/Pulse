...
export default async function SettingsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8 py-8 md:py-12 space-y-6">
      ...
      {/* Brand positioning */}
      <section className="bg-card border border-border rounded-2xl p-6">
        <SectionHeading icon={Target} title="Brand positioning" />
        <div className="flex items-start justify-between gap-6">
          <div className="min-w-0">
            ...
            >
              Mission, audience, differentiators — what {tenant.name} stands for
            </p>
            <p className="text-xs text-gray-1000 dark:text-text-muted mt-1">
              Feeds every blog generation, SERP analysis, content scoring, and
              caption generation as shared context. Layers with brand voice.
            </p>
          </div>
          <Link
      ...
      {/* Trend scouts */}
      <section className="bg-card border border-border rounded-2xl p-6">
        <SectionHeading icon={TrendingUp} title="Trend scouts" />
        <div className="flex items-start justify-between gap-6">
          <div className="min-w-0">
            <p
              className="text-sm text-gray-1200 dark:text-foreground"
              style={{ fontFamily: "'Satoshi-500', var(--font-sans)" }}
            >
              Hashtags + region the daily scraper tracks for {tenant.name}
            </p>
            <p className="text-xs text-gray-1000 dark:text-text-muted mt-1">
              Instagram top-posts + TikTok Creative Center trending. Shows up
              on Viral trends.
            </p>
          </div>
          <Link
      ...
      {/* Storage */}
      <section className="bg-card border border-border rounded-2xl p-6">
        <SectionHeading icon={HardDrive} title="Storage" />
        <div className="flex items-start justify-between gap-6">
          <div className="min-w-0">
            <p
              className="text-sm text-gray-1200 dark:text-foreground"
              style={{ fontFamily: "'Satoshi-500', var(--font-sans)" }}
            >
              Extracted videos + thumbnails
            </p>
            <p className="text-xs text-gray-1000 dark:text-text-muted mt-1">
              See how much of your Supabase Storage quota is used and prune
              old files to stay under the free-tier limit.
            </p>
          </div>
          <Link
