  ...
  return (
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="text-center max-w-md">
        ...
        <Link
          href="/dashboard"
          className="inline-flex px-4 py-2 bg-accent-purple text-white text-sm font-medium rounded-lg hover:bg-accent-purple/90 transition-colors duration-150 active:scale-[0.98]"
        >
          Back to Dashboard
        </Link>
      </div>
