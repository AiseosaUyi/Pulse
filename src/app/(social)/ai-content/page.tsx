  ...
  return (
    <div className="p-4 md:p-8 max-w-[1200px]">
      ...
      <div className="bg-card rounded-xl p-6 border border-border/50">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-white mb-5">AI-Generated Suggestions</h2>
        <div className="space-y-4">
          {suggestions.map((s) => (
            <div key={s.id} className="p-4 rounded-lg bg-background border border-border/30 hover:border-border transition-colors">
              ...
              <p className="text-white text-sm leading-relaxed mb-3">{s.caption}</p>
              <div className="flex items-center justify-between mt-3 pt-3 border-t border-border/20">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button className="px-3 py-1.5 text-xs bg-background text-text-muted rounded-md hover:text-white transition-colors border border-border/30">
                    Dismiss
                  </button>
                </div>
              </div>
