      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-sidebar border border-border rounded-xl w-full max-w-lg max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="flex items-center justify-between p-5 border-b border-border/50">
            <h2 className="text-lg font-semibold text-white">Add Competitor Post</h2>
          ...
          <form action={handleSubmit} className="p-5 space-y-4">
            ...
            <div>
              ...
              <select
                name="competitorId"
                required
                className="w-full bg-card border border-border rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-accent-purple"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-card border border-border rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-text-muted/50 focus:outline-none focus:ring-2 focus:ring-accent-purple"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-card border border-border rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-text-muted/50 focus:outline-none focus:ring-2 focus:ring-accent-purple resize-none"
              />
            </div>
              ...
              <div className="grid grid-cols-4 gap-2">
                <div>
                  <input type="number" name="views" min="0" placeholder="Views"
                    className="w-full bg-card border border-border rounded-lg px-2.5 py-2 text-sm text-white placeholder:text-text-muted/50 focus:outline-none focus:ring-2 focus:ring-accent-purple" />
                </div>
                <div>
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full py-2.5 rounded-lg text-sm font-semibold text-white bg-gradient-to-r from-accent-purple to-accent-pink hover:opacity-90 transition-opacity disabled:opacity-50"
            >
